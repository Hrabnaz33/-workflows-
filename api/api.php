...
if ($action === 'dry-run') {
    ...
    // Hier w�rdest du die �nderungen anwenden (z. B. Datei schreiben oder CMS-API aufrufen) // ich fuege zum test einen weiteren Kommentar ein
    logAction('Deployment durchgef�hrt: ' . json_encode($data), $logFile);
    echo json_encode([
